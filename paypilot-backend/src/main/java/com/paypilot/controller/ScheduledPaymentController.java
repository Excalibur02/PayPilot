...
public class ScheduledPaymentController {
    ...
    public List<ScheduledPayment> getUpcomingPayments(@PathVariable Long userId) {
        return scheduledPaymentService.getUpcomingPayments(userId);
    }

    @GetMapping("/history/{userId}")
    public List<ScheduledPayment> getPastPayments(@PathVariable Long userId) {
        return scheduledPaymentService.getPastPayments(userId);
    }
